...
Note: This fork is intended to hold a fix for a jQuery UI 1.13+ compatibility issue. Unless someone wants to contribute, I do not plan to further maintain this code (though who knows what the future holds).
